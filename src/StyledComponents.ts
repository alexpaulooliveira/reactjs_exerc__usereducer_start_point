...
export const SBLeft = styled(ArrowLeftCircleFill)<{onClick?: MouseEventHandler}>`
  color: ${TITLE_COLOR};
  size: 15;  
  display: inline-block;
  width: ${BUTTON_SIZE};
...
export const SBRight = styled(ArrowRightCircleFill)`
  color: ${TITLE_COLOR};
  size: 15;  
  display: inline-block;
  width: ${BUTTON_SIZE};
...
export const SBSave = styled(CloudArrowUpFill)`
  color: ${BUTTON_SAVE_COLOR};
  size: 15;  
  display: inline-block;
  width: ${BUTTON_SIZE};
`

export const SBLoad = styled(CloudArrowDownFill)`
  color: ${BUTTON_SAVE_COLOR};
  size: 15;  
  display: inline-block;
  width: 50px;
